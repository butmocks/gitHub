 ...
 */
const specialGreeting = greeting.bind(company, 'Bob', 'Marley', company.companyName);
specialGreeting();
 ...
 */
const getUkrainePopulation = getPopulation.bind(country, 43000, country.countryName);
